...
#'
#' @description Dataset to simulate Small Area Estimation using Hierarchical Bayesian Method under Zero Inflated Negative Binomial.
#'
#' This data is generated by these following steps:
#'
#' \enumerate{
#' \item Generate sampling random area effect \code{u.z} and \code{u.nz} with  \code{u.z ~ N(0,1)} and \code{u.nz ~ N(0,1)}.
...
#' \item Calculate \eqn{\pi}{\pi} = \eqn{exp(\gamma_{0} + x_{1}\gamma_{1} + x_{2}\gamma_{2} + u.z)}{exp(\gamma0 + x1\gamma1 + x2\gamma2 + u.z)} / \eqn{1 + exp(\gamma_{0} + x_{1}\gamma_{1} + x_{2}\gamma_{2} + u.z)}{1 + exp(\gamma0 + x1\gamma1 + x2\gamma2 + u.z)}
#' \item Calculate \eqn{\mu}{\mu} = \eqn{exp(\beta_{0} + x_{1}\beta_{1} + x_{2}\beta_{2} + u.nz)}{exp(\beta0 + x1\beta1 + x2\beta2 + u.nz)}
